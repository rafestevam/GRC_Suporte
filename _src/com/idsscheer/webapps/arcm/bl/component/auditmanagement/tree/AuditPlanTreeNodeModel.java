 ...
 */
public class AuditPlanTreeNodeModel extends DefaultTreeNodeModel {
    ...
    static {
        registerModelKeys(AuditPlanTreeNodeModel.class);
    }

    /* DO NOT USE DIRECTLY - Use #createInstance() instead */
    protected AuditPlanTreeNodeModel() {}
     ...
     */
    public static AuditPlanTreeNodeModel createInstance() {
        return Factory.createInstance(AuditPlanTreeNodeModel.class);
    }
}
